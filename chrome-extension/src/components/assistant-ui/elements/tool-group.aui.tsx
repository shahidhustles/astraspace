...
> &
  ...
  defaultOpen?: boolean;
  /** Opens for live tool work and closes once that work is complete. */
...
function ToolGroupRoot({
  ...
  const previousActiveRef = useRef(openWhileActive);

  useEffect(() => {
    if (isControlled || previousActiveRef.current === openWhileActive) return;
    previousActiveRef.current = openWhileActive;
    setUncontrolledOpen(openWhileActive === true);
  }, [isControlled, openWhileActive]);
